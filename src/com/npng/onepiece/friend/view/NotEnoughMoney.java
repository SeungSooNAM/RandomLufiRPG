...
public class NotEnoughMoney extends JPanel{
	
	private NotEnoughMoney notEnoughMoney;
	...
	public NotEnoughMoney(String name) {
		...
		JLabel failedText = new JLabel("비용이 부족합니다. ");
	...
	public class MyMouseAdapter extends MouseAdapter{
		...
		public void mouseClicked(MouseEvent e) {
			if(e.getSource() == okPanel) {
				...
				ViewUtil.changePanel(notEnoughMoney, new SelectInfo(name));
