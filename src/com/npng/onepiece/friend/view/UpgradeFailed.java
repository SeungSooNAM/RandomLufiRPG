...
public class UpgradeFailed extends JPanel{
	
	private UpgradeFailed upgradeFailed;
	...
	public UpgradeFailed(String name) {
		this.setSize(1200, 800);
		this.upgradeFailed = this;
		...
		JLabel failedText = new JLabel("강화에 실패하였습니다.");
		failedText.setFont(font2);
		failedText.setForeground(Color.BLUE);
		failedText.setBounds(50, 50, 320, 80);
		check.add(failedText);
		...
		check.add(okPanel);
		Image imgOk = new ImageIcon("image/friend/확인.png").getImage().getScaledInstance(150, 55, 0);
	...
	public class MyMouseAdapter extends MouseAdapter{
		...
		public void mouseClicked(MouseEvent e) {
			if(e.getSource() == okPanel) {
				...
				ViewUtil.changePanel(upgradeFailed, new SelectInfo(name));
